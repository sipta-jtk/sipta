...
Route::group(['prefix' => 'koordinator-kelola-pengajuan-jadwal', 'as' => 'kelola.'], function () {
    Route::group(['prefix' => '{tipe}', 'as' => 'jadwal.'], function () {
        ...
        Route::put('/verifikasi/{id}', [VerifikasiPengajuanJadwalController::class, 'verifikasi'])->name('verifikasi');
    });
});

Route::group(['prefix' => 'pembimbing-kelola-pengajuan-jadwal', 'as' => 'kelola.'], function () {
    Route::group(['prefix' => '{tipe}', 'as' => 'jadwal.'], function () {
