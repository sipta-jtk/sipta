                ...
                @endforeach 
                     ...
                     <x-adminlte-modal id="detailMhs" title="Detail Data Mahasiswa" theme="blue" size='lg' >
                                <p class="text-secondary text-md border-bottom">Identitas Pribadi</p>
                                    <x-adminlte-input readonly name="nama-detail" id="nama-detail" label="Nama"/>
                                    <x-adminlte-input readonly name="nim-detail" id="nim-detail" label="NIM" />
                                    <x-adminlte-input readonly name="Tahun Masuk" label="Tahun Masuk" id="tahun_masuk-detail"/>
                                    <x-adminlte-input readonly name="Kelas" label="Kelas" id="kelas-detail" placeholder="Kelas"/>
                                    <x-adminlte-input readonly name="Prodi" label="Prodi" id="prodi-detail" placeholder="Prodi"/>
                                     <x-adminlte-input readonly name="Status User" label="Status" id="status_user-detail" placeholder="Prodi"/>
                                <p class="text-secondary text-md border-bottom">Kontak</p>
                                    <x-adminlte-input readonly name="no_whatsapp-detail" id="no_whatsapp-detail" label="Nomor Whatsapp" placeholder="Nomor Whatsapp"  />
                                    <x-adminlte-input readonly name="email-detail" id="email-detail" label="Email" placeholder="Email" />
                     </x-adminlte-modal>
