                ...
                <thead class="sticky-header">
                    <tr class="bg-dark text-white">
                        <th rowspan="2" class="sticky-column no-sort"
                            style="width: 5%; position: sticky; left: 0; background: #343a40;">No</th>
                        <th rowspan="2" class="sticky-column no-sort"
                            style="width: 15%; position: sticky; left: 5%; background: #343a40;">Kelompok
                        </th>
...
$(document).ready(function () {
    ...
    $(".pembimbing").each(function () {
        ...
        const detailContainer = $(this).closest("td").next().find(".detail-content");
        fetchDosenDetail(nip, detailContainer); // langsung fetch saat load
    });
