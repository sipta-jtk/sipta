        ...
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center flex-wrap px-2 mb-3">
                <div class="d-flex align-items-center">
                    ...
                    <!-- Length Change untuk SDD -->
                    <div id="custom-length-sdd"></div>
                </div>

                <!-- Tombol Tambah -->
                <button id="btn-tambah-sdd" class="btn btn-primary btn-md" data-toggle="modal" data-target="#TambahDokumen" data-id-subkategori="{{ $subkategoriSdd->id_subkategori }}">
