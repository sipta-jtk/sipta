...
@section('content')
    <div class="card p-4">
        ...
        <!-- Form Penilaian -->
        @php
            $actionUrl = isset($nilaiKriteria) && count($nilaiKriteria) > 0 ? url('kelola-penilaian-ta/nilai-seminar/'. $idFta . '/nilai/' . $data['id_fta'] . '/edit') : url('penilaian-ta/nilai-seminar/'. $idFta . '/nilai/' . $data['id_fta'] . '/tambah');
        @endphp
        <form action="{{ $actionUrl }}" method="POST">
            ...
            <div class="row mt-0">
                <div class="col-md-12 text-right">
                    ...
                    <a href="{{ url('kelola-penilaian-ta/nilai-seminar/'. $idFta . '/masukan/' . ($data['id_fta'] + 1)) }}" class="btn btn-primary">Selanjutnya</a>
                </div>
            </div>
        </form>
    </div>
