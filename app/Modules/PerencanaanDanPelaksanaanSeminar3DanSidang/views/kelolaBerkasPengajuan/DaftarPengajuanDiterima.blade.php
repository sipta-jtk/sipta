...
@section('content_header')
    ...
    <div>
        @component('KelolaPenilaianTA.views.components.breadcrumb', ['links'=> [
                ...
                ['url' => url('/sipta-dev/kelola-pengajuan-berkas/'.$tipe.'/diterima'), 'label' => 'Daftar Pengajuan Verifikasi Berkas Diterima'],
            ]])
        @endcomponent
    </div>
@stop
            ...
            let table = $('#pengajuanTable').DataTable({
                ...
                columns: [
                    ...
                    { 
                        ...
                        className: 'text-center',
                        render: function(data, type, row) {
                            return data; // Tampilkan tanggal verifikasi jika ada, jika tidak tampilkan '-'
                        }
                    },
                ],
                language: {
