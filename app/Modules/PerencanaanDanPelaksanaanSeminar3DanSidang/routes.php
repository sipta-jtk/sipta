...
Route::middleware(['auth', 'can:mahasiswa_ta'])->group(function () {
    Route::get('/verifikasi-berkas-3', [VerifikasiBerkasPengajuanMahasiswaController::class, 'create'])->middleware(['auth'])->name('verifikasi.create');
    Route::post('/verifikasi-berkas-3', [VerifikasiBerkasPengajuanMahasiswaController::class, 'store'])->middleware(['auth'])->name('verifikasi.store');
